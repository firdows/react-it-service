//กำหนดคำเรมตนให state เชน เชควำขอมลทดงมำ error หรอไมเรำกจะเชคจำก isRejected
//ซงถำเรำไมกำหนด state  เรมตนกจะไมม object ชอ isRejected ใหเรยกใชงำน
const initialState = {
